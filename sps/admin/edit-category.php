...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "update tblcategory set VehicleCat='$catname', price='$amount' where ID='$eid'");
    if ($query) {
...
<head>
    ...
    <title>SPS - Manage Category</title>
...
?>              
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="amount" name="amount" class="form-control" placeholder="Amount" value="<?php  echo $row['price'];?>" required="true"></div>
                                    </div> 
