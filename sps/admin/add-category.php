...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into  tblcategory(VehicleCat, price) value('$catname','$price')");
    if ($query) {
                            ...
                            <div class="card-body card-block">
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="amount" name="amount" class="form-control" placeholder="Amount" required="true"></div>
                                    </div>   
