            ...
            <div class="container">
                <div class="login-content" style="margin-top:20vh;">
                    <div class="login-logo">
                        <a href="index.php">
                            <h2 style="color: whitesmoke; font-weight:bold; text-transform:uppercase;" data-aos="zoom-in">Smart Parking
                                System</h2>
                        </a>
                    </div>
                    <div class="login-form " style="background-color:transparent; box-shadow: 0 0 30px 8px black;" data-aos="zoom-in">
                        <form method="post">
                            <h5 class="text-center text-white" style="font-weight: bold;">User Forgot Password</h5>
                            ...
                            <div class="checkbox">
                                ...
                                <label class="pull-right">
                                    <a href="login.php" class="text-primary">Signin</a>
                                </label>
