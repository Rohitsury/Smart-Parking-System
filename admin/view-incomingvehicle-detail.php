...
if(isset($_POST['submit']))
  {
    ...
    $que = mysqli_query($con, "UPDATE tblparking SET u_id = Null, vehicle_id = Null, price = Null, status = 0 WHERE vehicle_id = '$vehicle_id'");
     
   $query=mysqli_query($con, "update  tblvehicle set Remark='$remark',Status='$status' where ID='$cid'");
    if ($query) {
...
<head>
    ...
    <title>SPS - View Vehicle Detail</title>
...
<?php if($row['Status']==""){ ?>
 ...
 <tr>
    <input type="hidden" name="v_id" value="<?php echo $row['ID']; ?>">
